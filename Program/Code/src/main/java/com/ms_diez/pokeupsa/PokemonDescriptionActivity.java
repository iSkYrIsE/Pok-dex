...
public class PokemonDescriptionActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pokemonPosition = intent.getIntExtra(POKEMON_POSITION, -1);
        pokemonDto = pokemonViewModel.getPokemon(pokemonPosition);


        if(intent.getStringExtra("Identificador").equals("Personal")){
            pokemonDto = pokemonViewModel.getPokemonListaPersonal(pokemonPosition);
            personal = 1;
    ...
    public void onClick(View view) {
        ...
        if(personal == 1){
            Intent intent = new Intent();
            pokemonViewModel.borrarPokemon(pokemonPosition);
